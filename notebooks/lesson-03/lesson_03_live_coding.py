...
# %%
# TODO(LIVE): addestrare Logistic Regression con class_weight='balanced' e valutare su val set
...
# %%
# TODO(LIVE): addestrare Logistic Regression sul dataset ri-bilanciato da SMOTE
# Hint: usa X_train_sm, y_train_sm; produce y_pred_smote, y_prob_smote
...
# %%
# TODO(LIVE): costruire la curva bias-variance — loop su depth 1–20, calcolare AUC e F1 su train e val
# Hint: crea results_depth come lista di dict con chiavi depth, auc_train, auc_val, f1_train, f1_val;
#       alla fine crea df_depth = pd.DataFrame(results_depth) e stampalo
...
# %%
# TODO(LIVE): addestrare Random Forest con 200 alberi e class_weight='balanced'
# Hint: usa n_jobs=-1, random_state=SEED; produce y_pred_rf, y_prob_rf;
#       calcola anche y_pred_rf_tr e y_prob_rf_tr (predizioni su train) per il sanity check
...
# %%
# TODO(LIVE): calcolare la soglia di classificazione ottimale dalla curva Precision-Recall
# Hint: usa precision_recall_curve(y_val, y_prob_rf); calcola f1_scores_th = 2*p*r/(p+r+1e-9)
#       su ogni soglia; salva la soglia ottimale in BEST_THRESHOLD
...
# %%
# TODO(LIVE): tracciare le curve ROC di Dummy, LR, DT e RF su validation set in un unico grafico
